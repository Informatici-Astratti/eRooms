...
import { AvailableRooms, BookingData, createBooking, searchAvailableRooms, SearchAvailableRoomsParams } from './action'
...
export const BookingStepper = defineStepper(
    ...
    },
    {
        ...
        description: "Visualizza i tuoi dati e verifica la correttezza",
    },
    {
        id: "step4",
...
// Componente Sheet Booking Cliente

export default function CreateBookingCliente() {
        ...
        <React.Fragment>
            {
                !isSignedIn ?
                    (
                        <div className='flex flex-col items-center gap-4 my-auto p-5 border rounded-md'>
                            ...
                            <h1>Per Continuare devi Accedere oppure Registrarti</h1>
